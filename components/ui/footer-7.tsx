...
const defaultSocialLinks = [
  { icon: createElement(FaInstagram, { className: "size-5" }), href: "#", label: "Instagram" },
  { icon: createElement(FaFacebook, { className: "size-5" }), href: "#", label: "Facebook" },
...
export const Footer7 = ({
  ...
  return (
    <footer className="border-t bg-muted/10 py-16 md:py-20 mt-16 text-foreground">
